...
import com.smokebox.valkyrie.trigger.DamagingCircle;
import com.smokebox.valkyrie.trigger.DamagingLine;
import com.smokebox.valkyrie.trigger.DamagingRect;
import com.smokebox.valkyrie.trigger.Trigger;
...
public class Game extends ApplicationAdapter {
    ...
    public void addSkillUser(SkillUser user) {
        skillUsers.add(user);
    }

    public void addMunition(GeneralMunition munition) {
    ...
    public AssetManager getAssetManager() {
        if (constructorFin)
            System.out.println("AssetManager class at runtime. This should not happen!");
        return astmng;
    }
