...
public class Droid implements Moveable, Drawable, CollidesWithWorld, Wielding, ProjectileHittable, ImpulseAffected {
    ...
    public float getActiveDamage() {
        return activeWeapon.wep_damage;
    }

    public float getActiveRange() {
        return activeWeapon.proj_range;
    }
    ...
    public float getActiveAccuracy() {
        return activeWeapon.wep_accuracy;
    }

    public float getActiveInverseRoundsPerSecond() {
        return 1 / activeWeapon.rps_base;
    }

    public float getActiveProjectileSpeed() {
        return activeWeapon.proj_speed;
    }

    public float getActiveAimInfluence() {
        return activeWeapon.wep_aimInfluence;
    }
